...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public Chip contactChip;
        public Chip mapsChip;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            todayChip = itemView.findViewById(R.id.date_chip);
            contactChip = itemView.findViewById(R.id.contact_chip);
            mapsChip = itemView.findViewById(R.id.maps_chip);
            this.onTodoClickListener = todoClickListener;
            itemView.setOnClickListener(this);
            todoDeleteButton.setOnClickListener(this);
            contactChip.setOnClickListener(this);
        ...
        @Override
            ...
            } else if (id == R.id.contact_chip) {
                onTodoClickListener.onContactClick(currTodo);
            }
        }
